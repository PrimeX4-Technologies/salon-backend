...
export interface IOutboxEvent {
  ...
  aggregateType: "booking" | "waitlist" | "employee_schedule" | "time_off" | "booking_payment";
...
const OutboxEventSchema = new Schema<IOutboxEvent>(
  {
    ...
    aggregateType: {
      type: String,
      enum: ["booking", "waitlist", "employee_schedule", "time_off", "booking_payment"],
      required: true,
    },
...
OutboxEventSchema.index({ salonId: 1, aggregateType: 1, aggregateId: 1, createdAt: 1 });
